...
public class PacienteDTO {
     ...
     */
    public List<MedicamentoDTO> getMedicamentosDiarios() {
     ...
     */
    public void setMedicamentosDiarios(List<MedicamentoDTO> medicamentosDiarios) {
     ...
     */
    public List<CatalizadorDTO> getHabitos() {
        return habitos;
    }
